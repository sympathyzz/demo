    ...
    <div class="content">
      <header class="article-header">
        ...
        <div class="article-meta"> <span class="item article-meta-time">
          ...
          <a href="program" title="">${article.categoryid } ???????</a>
          </span> 
          <span class="item article-meta-views" data-toggle="tooltip" data-placement="bottom" title="查看：120">
          <i class="glyphicon glyphicon-eye-open"></i>
           		共${article.readcnt }次围观
           </span> <span class="item article-meta-comment" data-toggle="tooltip" data-placement="bottom" title="评论：0">
